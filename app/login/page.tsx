// this entire thing could be a server component and the "remember-me" and "show-password" buttons could be client components
"use client";
                        ...
                        <div>
                            <div className="relative group">
                                <input
                                    ...
                                    placeholder=" "
                                    className={`peer w-full bg-[#00000030] border ${errors.email
                                        ? "border-red-400/50"
                                        : "border-[#ffffff10]"
                        ...
                        <div>
                            <div className="relative group">
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder=" "
                                    className={`peer w-full bg-[#00000030] border ${errors.password
                                        ? "border-red-400/50"
                                        : "border-[#ffffff10]"
                                        } rounded-lg py-3 px-4 text-base focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/50 transition-all`}
                                />
