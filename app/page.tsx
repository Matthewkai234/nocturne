        ...
        <>
            ...
            <footer className="bg-gray-950 text-white py-6">
                <div className="max-w-screen-xl mx-auto text-center">
                    <p className="text-sm">
                        &copy; 2025 Nocturne. All Rights Reserved.
                    </p>
                    <div className="mt-4">
                        <a
                            href="https://www.facebook.com"
                            target="_blank"
                            className="text-white mx-4 hover:text-blue-600"
                        >
                            Facebook
                        </a>
                        <a
                            ...
                            target="_blank"
                            className="text-white mx-4 hover:text-blue-400"
                        >
                            Twitter
                        </a>
                        <a
                            ...
                            target="_blank"
                            className="text-white mx-4 hover:text-pink-600"
                        >
                            Instagram
                        </a>
                        <a
                            ...
                            target="_blank"
                            className="text-white mx-4 hover:text-blue-500"
                        >
                            LinkedIn
                        </a>
                    </div>
